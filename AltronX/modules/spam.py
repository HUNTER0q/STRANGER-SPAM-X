    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(altron) == 1:
            ...
            if int(e.chat_id) in GROUP:
                await e.reply("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪ  HUNTER ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.", parse_mde=None, link_preview=None )
            else:
...
async def hang(e):
    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(mkh) == 1:
            counter = int(mkh[0])
            if int(e.chat_id) in GROUP:
                await e.reply("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪꜱ HUNTER ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.", parse_mode=None, link_preview=None)
            else:

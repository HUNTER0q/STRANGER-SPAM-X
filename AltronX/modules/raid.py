...
async def spam(e):
    ...
    if e.sender_id in SUDO_USERS:
        ...
        if len(mkraid) == 2:
            ...
            g = a.id
            if int(g) in ALTRON:
                await e.reply("» ᴀʀᴇ.. ʏᴇ ᴛᴏ ᴛᴇʀᴀ ʜᴜɴᴛᴇʀ ᴘᴀᴘᴀ ʜᴀɪ", parse_mode=None, link_preview=None)
            elif int(g) in SUDO_USERS:
                await e.reply("» ᴀʙᴇ.. ʏᴇ LUND ʟᴇᴋᴀʀ ʙᴀɪᴛʜᴀ ʜᴀɪ", parse_mode=None, link_preview=None)
            else:
                c = a.first_name
